...
public final class EditActivity extends Activity
{
    ...
    private static final String HELP_URL = "http://www.metawatch.org/forums/board/19/remote-application-development"; //$NON-NLS-1$
    ...
    protected void onCreate(final Bundle savedInstanceState)
    {
        ...
        frame.addView(getLayoutInflater().cloneInContext(new ContextThemeWrapper(this, R.style.Theme_Locale_Light)).inflate(R.layout.locale_frame, frame, false));
        ...
        if (null == savedInstanceState)
        {
            ...
            {
                ((CheckBox) findViewById(R.id.disallowVib)).setChecked(forwardedBundle.getBoolean(PluginBundleManager.BUNDLE_EXTRA_DISALLOW_VIBRATION));
            }
        }
        /*
    ...
    public void finish()
    {
        ...
        {
            final boolean disallowVib = ((CheckBox) findViewById(R.id.disallowVib)).isChecked();
            ...
            returnBundle.putBoolean(PluginBundleManager.BUNDLE_EXTRA_DISALLOW_VIBRATION, disallowVib);
            ...
            returnIntent.putExtra(com.twofortyfouram.locale.Intent.EXTRA_STRING_BLURB,
                    getString(disallowVib ? R.string.vibDisallowed : R.string.vibAllowed));
